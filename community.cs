...
public void dqSupport();
public void groupListsSetup();
public void groupListsStats();
public void groupListsUpdate(int x, int y);
public void mergeCommunities(int i, int j);
public void readInputFile();
public void recordGroupLists();
...
public struct outparameters {
	short 		textFlag;			// 0: no console output
...
public maxheap   *h;				// heap of values from max_i{dQ_ij}
public double    *Q;				// Q(t)
